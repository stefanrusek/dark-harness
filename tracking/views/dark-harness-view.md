...
| ID | Title | Blocked by |
| --- | --- | --- |
| [DH-0010](../DH-0010-no-context-window-compaction-or-cache-control.md) | No context-window compaction/token-budget handling, and no prompt caching (`cache_control`) | architect design pass in progress |
