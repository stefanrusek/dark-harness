...
| [DH-0099](../DH-0099-dh-doctor-prints-nothing-until-all-models-are-checked-should-show-live-per-model-progress.md) | dh doctor prints nothing until all models are checked; should show live per-model progress | feature | stefan |
