...
// DH-0093: same test-vector table as src/tui/commands.test.ts — the two clients keep
// independent parser modules (see this file's header comment for why), verified against
// identical vectors so the grammar can't silently drift between TUI and Web.
